...
router
  .route("/")
  .get(pagination.middleware(1, 1000), userController.getAllUser)
...
router
  ...
  .post(userValidator.forgotPassword, userController.forgotPassword);
router
  .route("/reset-password")
  .post(userValidator.resetPassword, userController.resetPassword);
